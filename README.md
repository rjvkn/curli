...
Download a [binary package](https://github.com/rjvkn/curli/releases)
...
```sh
docker run --rm -it rjvkn/curli [CURL_OPTIONS...] [METHOD] URL [ITEM [ITEM]]

docker run --rm -it rjvkn/curli version
docker run --rm -it rjvkn/curli -I https://github.com
```
